...
SQLCipher for Android runs on Android from 5.0 (API 21 - Lollipop), for `armeabi-v7a`, `x86`, `x86_64`, and `arm64_v8a` architectures.
...
In order to build `android-database-sqlcipher` from source you will need both the Android SDK, Gradle, Android NDK, SQLCipher core source directory, and an OpenSSL source directory.

Recommended Android NDK version: r25b (LTS)
